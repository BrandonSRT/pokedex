...
import {StyleSheet, View, Image,Button,TouchableOpacity, Text, useColorScheme, SafeAreaView, StatusBar} from "react-native"
        ...
        <View style={[styles.container, {backgroundColor:currentPokemon.color}]}>
            ...
            <SafeAreaView>
                <View style={styles.row}>
                    ...
                    <Text style={[styles.pokemonName,{textAlign:'right', marginRight:20, fontSize:25},
                    ]}>
                        #{currentPokemon.id}
                    </Text>
                ...
                <View style={[styles.pokemonTypeContainer, {alignSelf: 'center', backgroundColor: currentPokemon.color}]}>
                    <Text style={{color:Colors.white, paddingHorizontal: 10, fontWeight: 'bold', fontSize: 16, textAlign:"center",}}>
                        {currentPokemon.type}</Text>
                    
                </View>
                <View>
                <Text style={{textAlign:"center", fontWeight:'bold', fontSize:20, marginTop: 20, color: currentPokemon.color}}>
                        About
                </Text>
